...
function GuidedBuilderTab({ configOptions, configLoadStatus, diagnostic }: {
  ...
  return (
    <section className="artifact-panel launch-scenario-card">
      <div className="launch-scenario-head">
        <div>
          <div className="section-label">Guided</div>
          <h3>Scenario Configuration</h3>
          <p className="artifact-meta">
            Build a contract-faithful launch payload from operator-safe controls.
          </p>
        </div>
      </div>
      ...
      <form className="launch-form launch-scenario-form" onSubmit={(e) => e.preventDefault()}>

        {/* Template base selector */}
        <div className="launch-form-row launch-form-row-wide">
        ...
        <div className="launch-form-row launch-form-row-wide no-border">
